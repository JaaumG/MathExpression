...
public abstract class IntegralEvaluator {
    ...
    public static BigDecimal integrate(ExpressionEvaluator expressionEvaluator, String function, String variable, BigDecimal lowerBound, BigDecimal upperBound, int segments) {
